...
import 'package:foodninja1/homePageNav/chatPage/finishOrder/voucherPromo/view.dart';
import 'package:simple_gradient_text/simple_gradient_text.dart';

import '../../../../core/logic/helper_methods.dart';

class RateRestView extends StatefulWidget {
  const RateRestView({Key? key}) : super(key: key);

  @override
  State<RateRestView> createState() => _RateRestViewState();
}

class _RateRestViewState extends State<RateRestView> {
  bool isRate = false;
                ...
                child: Column(
                  ...
                  children: [
                    Padding(
                      ...
                      child: Image.asset(
                        "assets/images/ResturantImage2.png",
                        fit: BoxFit.scaleDown,
                        width: 170.w,
                        height: 170.h,
                      ),
